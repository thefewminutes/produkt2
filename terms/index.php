<?php # index.php
// this is the Terms of Use page of the site

// include the configuration file for error management and such
require_once ('../includes/config.inc.php');

// set the page title and include the HTML header
$page_title = 'Mark D. Johnson - Terms of Use';
...
?>
        	<hgroup>
        		...
        		<p>2. The site editor's service<br />
        		...
        		<p>4. Privacy policy<br />
        		  Registration data and other personally identifiable information that the site may collect is subject to the terms of the site editor's Privacy policy.</p>
        		...
        		<p>7. Submission of content on this web site<br />
        		  By providing any content to this web site:<br />
        		...
        		<p>10. DISCLAIMER OF WARRANTIES<br />
        		...
        		<p>11. LIMITATION OF LIABILITY<br />
        		...
        		<p>13. Notification of copyright infringement<br />
        		  If you believe that your property has been used in any way that could be considered a copyright infringement or a violation of your intellectual property rights, the site editor\'s copyright agent may be contacted via:</p>
        		<p>e-mail to the site administrator</p>
        		<p>[Other contact information, if published on the site:]</p>
        		<p>14. Applicable law<br />
        		...
        		<p>15. Miscellaneous information<br />
